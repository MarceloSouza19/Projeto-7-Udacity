...
public class TelaPrincipalActivity extends AppCompatActivity {
    ...
    List<ContentValues> listaConteudos = this.retornarDados();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper.inserirDados(listaConteudos);

        this.exibirDados(this.buscarDados());

    }

    public void exibirDados(Cursor cursor){
